...
@Service
public class Hrdb23ProcedureExecutorServiceImpl implements Hrdb23ProcedureExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Hrdb23ProcedureExecutorServiceImpl.class);

	@Autowired
	@Qualifier("hrdb23WMProcedureExecutor")
